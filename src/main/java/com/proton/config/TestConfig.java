...
public class TestConfig implements CommandLineRunner {
        ...
        public void run(String... args) throws Exception {
                ...
                // Janeiro 2025 - Protocolos com datas agrupadas
                Protocolo prot1 = new Protocolo(null, secSaude, mun1, end2, "Assunto do protocolo", new Date(124, 0, 5),
                                "Descrição do protocolo", Status.CIENCIA, 100.0, "001-2025", prazo2);
                Protocolo prot2 = new Protocolo(null, secEducacao, mun2, end3, "Outro assunto", new Date(124, 0, 5),
                                "Outra descrição", Status.CIENCIA, 150.0, "002-2025", prazo1);
                Protocolo prot3 = new Protocolo(null, secMeioAmb, mun2, end3, "Teste", new Date(124, 0, 5), "teste",
                                Status.CIENCIA, 150.0, "003-2025", prazo3);

                Protocolo prot4 = new Protocolo(null, secMeioAmb, mun1, end2, "Assunto do protocolo",
                                new Date(124, 0, 8),
                                "Descrição do protocolo", Status.CIENCIA, 100.0, "004-2025", prazo2);
                Protocolo prot5 = new Protocolo(null, secSaude, mun1, end2, "Assunto do protocolo", new Date(124, 0, 8),
                                "Descrição do protocolo", Status.CIENCIA, 100.0, "005-2025", prazo1);
                Protocolo prot6 = new Protocolo(null, secSaude, mun1, end2, "Assunto do protocolo", new Date(124, 0, 8),
                                "Descrição do protocolo", Status.CIENCIA, 100.0, "006-2025", prazo3);

                // Grupo de protocolos no dia 12/01/2025
                Protocolo prot7 = new Protocolo(null, secEducacao, mun2, end3, "Reforma escolar", new Date(124, 0, 12),
                ...
                Protocolo prot8 = new Protocolo(null, secSaude, mun1, end2, "Compra de medicamentos",
                                new Date(124, 0, 12),
                                "Aquisição de remédios para posto", Status.CIENCIA, 15000.0, "008-2025", prazo2);
                Protocolo prot9 = new Protocolo(null, secMeioAmb, mun2, end3, "Plantio de árvores",
                                new Date(124, 0, 12),
                                "Reflorestamento área urbana", Status.CIENCIA, 5000.0, "009-2025", prazo3);

                // Grupo de protocolos no dia 15/01/2025
                ...
                Protocolo prot11 = new Protocolo(null, secMeioAmb, mun1, end4, "Distribuição de sementes",
                                new Date(124, 0, 15),
                                "Apoio a agricultores familiares", Status.CIENCIA, 8000.0, "011-2025", prazo2);
                Protocolo prot12 = new Protocolo(null, secSaude, mun1, end2, "Cesta básica", new Date(124, 0, 15),
                                "Distribuição de alimentos", Status.CIENCIA, 20000.0, "012-2025", prazo3);

                // Grupo de protocolos no dia 18/01/2025
                Protocolo prot13 = new Protocolo(null, secEducacao, mun2, end3, "Compra de livros",
                                new Date(124, 0, 18),
                                "Aquisição para biblioteca", Status.CIENCIA, 10000.0, "013-2025", prazo1);
                Protocolo prot14 = new Protocolo(null, secSaude, mun1, end2, "Campanha vacinação", new Date(124, 0, 18),
                                "Vacinação contra influenza", Status.CIENCIA, 15000.0, "014-2025", prazo2);
                Protocolo prot15 = new Protocolo(null, secMeioAmb, mun1, end4, "Coleta seletiva", new Date(124, 0, 18),
                                "Implantação de programa", Status.CIENCIA, 30000.0, "015-2025", prazo3);

                // Grupo de protocolos no dia 22/01/2025
                Protocolo prot16 = new Protocolo(null, secEducacao, mun2, end3, "Construção de ponte",
                                new Date(124, 0, 22),
                                "Ponte sobre o rio X", Status.CIENCIA, 500000.0, "016-2025", prazo1);
                Protocolo prot17 = new Protocolo(null, secMeioAmb, mun1, end1, "Curso agricultura orgânica",
                                new Date(124, 0, 22),
                                "Capacitação para produtores", Status.CIENCIA, 5000.0, "017-2025", prazo2);
                Protocolo prot18 = new Protocolo(null, secSaude, mun1, end4, "Abrigo temporário", new Date(124, 0, 22),
                                "Abrigo para população em situação de rua", Status.CIENCIA, 40000.0, "018-2025",
                                prazo3);

                // Grupo de protocolos no dia 25/01/2025
                Protocolo prot19 = new Protocolo(null, secEducacao, mun1, end2, "Tablets para alunos",
                                new Date(124, 0, 25),
                                "Aquisição de dispositivos", Status.CIENCIA, 60000.0, "019-2025", prazo1);
                Protocolo prot20 = new Protocolo(null, secSaude, mun2, end3, "Equipamento hospitalar",
                                new Date(124, 0, 25),
                                "Compra de aparelhos médicos", Status.CIENCIA, 250000.0, "020-2025", prazo2);
                Protocolo prot21 = new Protocolo(null, secMeioAmb, mun1, end2, "Recuperação de nascente",
                                new Date(124, 0, 25),
                                "Proteção de nascente urbana", Status.CIENCIA, 15000.0, "021-2025", prazo3);

                // Fevereiro 2025 - Protocolos agrupados
                Protocolo prot22 = new Protocolo(null, secMeioAmb, mun1, end4, "Drenagem pluvial", new Date(124, 1, 3),
                                "Obras de drenagem no bairro Y", Status.CIENCIA, 80000.0, "022-2025", prazo1);
                Protocolo prot23 = new Protocolo(null, secSaude, mun2, end3, "Feira do produtor", new Date(124, 1, 3),
                                "Organização de feira semanal", Status.CIENCIA, 3000.0, "023-2025", prazo2);

                // Grupo de protocolos no dia 7/02/2025
                Protocolo prot24 = new Protocolo(null, secEducacao, mun1, end2, "Bolsa família", new Date(124, 1, 7),
                                "Processamento de benefícios", Status.CIENCIA, 120000.0, "024-2025", prazo3);
                Protocolo prot25 = new Protocolo(null, secEducacao, mun1, end4, "Reforma quadra esportiva",
                                new Date(124, 1, 7),
                                "Melhorias na quadra da escola", Status.CIENCIA, 35000.0, "025-2025", prazo1);

                // Continuação com o mesmo padrão...
                Protocolo prot26 = new Protocolo(null, secSaude, mun1, end2, "Contratação de médicos",
                                new Date(124, 1, 10),
                                "Processo seletivo para PSF", Status.CIENCIA, 200000.0, "026-2025", prazo2);
                Protocolo prot27 = new Protocolo(null, secMeioAmb, mun2, end3, "Educação ambiental",
                                new Date(124, 1, 10),
                                "Palestras em escolas", Status.CIENCIA, 5000.0, "027-2025", prazo3);

                // Grupo de protocolos no dia 14/02/2025
                ...
                Protocolo prot29 = new Protocolo(null, secSaude, mun1, end4, "Apoio à apicultura", new Date(124, 1, 14),
                                "Distribuição de kits apícolas", Status.CIENCIA, 12000.0, "029-2025", prazo2);
                Protocolo prot30 = new Protocolo(null, secEducacao, mun2, end3, "Centro dia idosos",
                                new Date(124, 1, 14),
                                "Manutenção do centro", Status.CIENCIA, 45000.0, "030-2025", prazo3);

                // Março 2025 - Protocolos agrupados
                Protocolo prot31 = new Protocolo(null, secEducacao, mun1, end2, "Transporte escolar",
                                new Date(124, 2, 4),
                                "Manutenção de frota", Status.CIENCIA, 75000.0, "031-2025", prazo1);
                Protocolo prot32 = new Protocolo(null, secSaude, mun1, end4, "Farmácia popular", new Date(124, 2, 4),
                                "Abastecimento de medicamentos", Status.CIENCIA, 30000.0, "032-2025", prazo2);

                // Grupo de protocolos no dia 9/03/2025
                Protocolo prot33 = new Protocolo(null, secMeioAmb, mun1, end2, "Fiscalização ambiental",
                                new Date(124, 2, 9),
                                "Operação de fiscalização", Status.CIENCIA, 15000.0, "033-2025", prazo3);
                Protocolo prot34 = new Protocolo(null, secEducacao, mun2, end3, "Construção de creche",
                                new Date(124, 2, 9),
                                "Obra do PAC", Status.CIENCIA, 600000.0, "034-2025", prazo1);
                Protocolo prot35 = new Protocolo(null, secSaude, mun1, end1, "Irrigação comunitária",
                                new Date(124, 2, 9),
                                "Sistema de irrigação", Status.CIENCIA, 45000.0, "035-2025", prazo2);

                // Continuação Março 2025
                Protocolo prot36 = new Protocolo(null, secSaude, mun1, end4, "Cras móvel", new Date(124, 2, 14),
                                "Atendimento em áreas remotas", Status.CIENCIA, 35000.0, "036-2025", prazo3);
                Protocolo prot37 = new Protocolo(null, secEducacao, mun2, end3, "Concurso público",
                                new Date(124, 2, 14),
                                "Processo seletivo professores", Status.CIENCIA, 120000.0, "037-2025", prazo1);

                // Grupo de protocolos no dia 18/03/2025
                Protocolo prot38 = new Protocolo(null, secSaude, mun1, end2, "SAMU", new Date(124, 2, 18),
                                "Manutenção de ambulâncias", Status.CIENCIA, 180000.0, "038-2025", prazo2);
                Protocolo prot39 = new Protocolo(null, secMeioAmb, mun1, end4, "Parque ecológico", new Date(124, 2, 18),
                                "Manutenção do parque", Status.CIENCIA, 25000.0, "039-2025", prazo3);
                Protocolo prot40 = new Protocolo(null, secEducacao, mun1, end1, "Casa popular", new Date(124, 2, 18),
                                "Construção de moradias", Status.CIENCIA, 800000.0, "040-2025", prazo1);

                // Abril 2025
                Protocolo prot41 = new Protocolo(null, secSaude, mun2, end3, "Feira agroecológica", new Date(124, 3, 2),
                                "Organização mensal", Status.CIENCIA, 8000.0, "041-2025", prazo2);
                Protocolo prot42 = new Protocolo(null, secSaude, mun1, end2, "Cadastro único", new Date(124, 3, 2),
                                "Atualização cadastral", Status.CIENCIA, 15000.0, "042-2025", prazo3);

                // Grupo de protocolos no dia 7/04/2025
                Protocolo prot43 = new Protocolo(null, secEducacao, mun1, end4, "Biblioteca móvel", new Date(124, 3, 7),
                                "Projeto de leitura", Status.CIENCIA, 25000.0, "043-2025", prazo1);
                Protocolo prot44 = new Protocolo(null, secSaude, mun2, end3, "Testes rápidos", new Date(124, 3, 7),
                ...
                Protocolo prot45 = new Protocolo(null, secMeioAmb, mun1, end2, "Reciclagem de óleo",
                                new Date(124, 3, 7),
                                "Campanha de coleta", Status.CIENCIA, 5000.0, "045-2025", prazo3);

                // Grupo de protocolos no dia 12/04/2025
                Protocolo prot46 = new Protocolo(null, secEducacao, mun1, end4, "Calçamento", new Date(124, 3, 12),
                                "Pavimentação de vias", Status.CIENCIA, 200000.0, "046-2025", prazo1);
                Protocolo prot47 = new Protocolo(null, secSaude, mun1, end1, "Defesa sanitária", new Date(124, 3, 12),
                                "Controle de pragas", Status.CIENCIA, 18000.0, "047-2025", prazo2);

                // Maio 2025
                Protocolo prot48 = new Protocolo(null, secSaude, mun2, end3, "Acolhimento institucional",
                                new Date(124, 4, 5),
                                "Casa de passagem", Status.CIENCIA, 60000.0, "048-2025", prazo3);
                Protocolo prot49 = new Protocolo(null, secEducacao, mun1, end2, "Material escolar", new Date(124, 4, 5),
                                "Distribuição de kits", Status.CIENCIA, 120000.0, "049-2025", prazo1);
                Protocolo prot50 = new Protocolo(null, secSaude, mun1, end4, "Oftalmologia", new Date(124, 4, 5),
                                "Consultas especializadas", Status.CIENCIA, 45000.0, "050-2025", prazo2);

                // Grupo de protocolos no dia 14/05/2025
                Protocolo prot51 = new Protocolo(null, secMeioAmb, mun2, end3, "Arborização", new Date(124, 4, 14),
                                "Plantio de mudas", Status.CIENCIA, 15000.0, "051-2025", prazo3);
                Protocolo prot52 = new Protocolo(null, secEducacao, mun1, end1, "Ponte estaiada", new Date(124, 4, 14),
                                "Construção de ponte", Status.CIENCIA, 1200000.0, "052-2025", prazo1);

                // Junho 2025
                Protocolo prot53 = new Protocolo(null, secSaude, mun1, end4, "Aquicultura", new Date(124, 5, 3),
                ...
                Protocolo prot54 = new Protocolo(null, secSaude, mun1, end2, "Projeto jovem cidadão",
                                new Date(124, 5, 3),
                                "Inclusão produtiva", Status.CIENCIA, 50000.0, "054-2025", prazo3);
                Protocolo prot55 = new Protocolo(null, secEducacao, mun2, end3, "Robótica educacional",
                                new Date(124, 5, 3),
                                "Oficinas nas escolas", Status.CIENCIA, 65000.0, "055-2025", prazo1);

                // Grupo de protocolos no dia 10/06/2025
                Protocolo prot56 = new Protocolo(null, secSaude, mun1, end2, "CAPS", new Date(124, 5, 10),
                ...
                Protocolo prot57 = new Protocolo(null, secMeioAmb, mun1, end4, "Unidade conservação",
                                new Date(124, 5, 10),
                                "Criação de reserva", Status.CIENCIA, 75000.0, "057-2025", prazo3);
                ...
                Protocolo prot59 = new Protocolo(null, secSaude, mun1, end1, "Agricultura familiar",
                                new Date(124, 6, 8),
                                "Fomento à produção", Status.CIENCIA, 40000.0, "059-2025", prazo2);
                Protocolo prot60 = new Protocolo(null, secSaude, mun1, end4, "Cozinha comunitária", new Date(124, 6, 8),
                                "Refeições para carentes", Status.CIENCIA, 35000.0, "060-2025", prazo3);

                // Grupo de protocolos no dia 16/07/2025
                Protocolo prot61 = new Protocolo(null, secEducacao, mun1, end2, "Educação inclusiva",
                                new Date(124, 6, 16),
                                "Adaptação de escolas", Status.CIENCIA, 95000.0, "061-2025", prazo1);
                Protocolo prot62 = new Protocolo(null, secSaude, mun2, end3, "Saúde bucal", new Date(124, 6, 16),
                ...
                Protocolo prot63 = new Protocolo(null, secMeioAmb, mun1, end2, "Coleta de lixo eletrônico",
                                new Date(124, 7, 4),
                                "Campanha de descarte", Status.CIENCIA, 12000.0, "063-2025", prazo3);
                Protocolo prot64 = new Protocolo(null, secEducacao, mun1, end4, "Praça pública", new Date(124, 7, 4),
                                "Reforma da praça central", Status.CIENCIA, 180000.0, "064-2025", prazo1);
                Protocolo prot65 = new Protocolo(null, secSaude, mun2, end3, "Secagem de grãos", new Date(124, 7, 4),
                                "Equipamentos para secagem", Status.CIENCIA, 70000.0, "065-2025", prazo2);

                // Grupo de protocolos no dia 13/08/2025
                Protocolo prot66 = new Protocolo(null, secSaude, mun1, end2, "Abrigo para mulheres",
                                new Date(124, 7, 13),
                                "Casa de acolhimento", Status.CIENCIA, 120000.0, "066-2025", prazo3);
                Protocolo prot67 = new Protocolo(null, secEducacao, mun1, end4, "Laboratório de ciências",
                                new Date(124, 7, 13),
                                "Equipamentos para escolas", Status.CIENCIA, 85000.0, "067-2025", prazo1);

                // Setembro 2025
                Protocolo prot68 = new Protocolo(null, secSaude, mun2, end3, "Fisioterapia", new Date(124, 8, 5),
                ...
                Protocolo prot69 = new Protocolo(null, secMeioAmb, mun1, end2, "Educação ambiental",
                                new Date(124, 8, 5),
                                "Projeto nas escolas", Status.CIENCIA, 15000.0, "069-2025", prazo3);
                ...
                // Grupo de protocolos no dia 15/09/2025
                Protocolo prot71 = new Protocolo(null, secSaude, mun2, end3, "Silo comunitário", new Date(124, 8, 15),
                                "Armazenagem de grãos", Status.CIENCIA, 90000.0, "071-2025", prazo2);
                Protocolo prot72 = new Protocolo(null, secSaude, mun1, end2, "Vale gás", new Date(124, 8, 15),
                ...
                Protocolo prot73 = new Protocolo(null, secEducacao, mun1, end4, "Formação de professores",
                                new Date(124, 9, 7),
                                "Capacitação continuada", Status.CIENCIA, 45000.0, "073-2025", prazo1);
                Protocolo prot74 = new Protocolo(null, secSaude, mun2, end3, "UTI móvel", new Date(124, 9, 7),
                ...
                Protocolo prot75 = new Protocolo(null, secMeioAmb, mun1, end2, "Monitoramento qualidade água",
                                new Date(124, 9, 7),
                                "Análise de corpos hídricos", Status.CIENCIA, 35000.0, "075-2025", prazo3);

                // Grupo de protocolos no dia 20/10/2025
                Protocolo prot76 = new Protocolo(null, secEducacao, mun1, end4, "Terminal rodoviário",
                                new Date(124, 9, 20),
                                "Construção de terminal", Status.CIENCIA, 1500000.0, "076-2025", prazo1);
                Protocolo prot77 = new Protocolo(null, secSaude, mun2, end3, "Irrigação por gotejamento",
                                new Date(124, 9, 20),
                                "Sistemas de irrigação", Status.CIENCIA, 60000.0, "077-2025", prazo2);

                // Novembro 2025
                Protocolo prot78 = new Protocolo(null, secSaude, mun1, end2, "Cras 24h", new Date(124, 10, 3),
                                "Ampliação de atendimento", Status.CIENCIA, 180000.0, "078-2025", prazo3);
                Protocolo prot79 = new Protocolo(null, secEducacao, mun1, end4, "Educação digital",
                                new Date(124, 10, 3),
                                "Inclusão digital nas escolas", Status.CIENCIA, 120000.0, "079-2025", prazo1);
                Protocolo prot80 = new Protocolo(null, secSaude, mun2, end3, "Hemocentro", new Date(124, 10, 3),
                                "Ampliação de hemocentro", Status.CIENCIA, 800000.0, "080-2025", prazo2);

                // Grupo de protocolos no dia 12/11/2025
                Protocolo prot81 = new Protocolo(null, secMeioAmb, mun1, end2, "Recuperação de APP",
                                new Date(124, 10, 12),
                                "Área de preservação", Status.CIENCIA, 45000.0, "081-2025", prazo3);
                Protocolo prot82 = new Protocolo(null, secEducacao, mun1, end4, "Ciclovia", new Date(124, 10, 12),
                                "Construção de ciclovias", Status.CIENCIA, 250000.0, "082-2025", prazo1);

                // Dezembro 2025
                Protocolo prot83 = new Protocolo(null, secSaude, mun2, end3, "Agroindústria", new Date(124, 11, 5),
                                "Apoio a pequenas agroindústrias", Status.CIENCIA, 95000.0, "083-2025", prazo2);
                Protocolo prot84 = new Protocolo(null, secSaude, mun1, end2, "Moradia temporária", new Date(124, 11, 5),
                                "Abrigo emergencial", Status.CIENCIA, 200000.0, "084-2025", prazo3);
                Protocolo prot85 = new Protocolo(null, secEducacao, mun1, end4, "Biblioteca digital",
                                new Date(124, 11, 5),
                                "Plataforma de livros digitais", Status.CIENCIA, 75000.0, "085-2025", prazo1);

                // Janeiro 2026
                Protocolo prot86 = new Protocolo(null, secSaude, mun2, end3, "Centro de reabilitação",
                                new Date(125, 0, 8),
                                "Construção de centro", Status.CIENCIA, 1200000.0, "086-2026", prazo2);
                Protocolo prot87 = new Protocolo(null, secMeioAmb, mun1, end2, "Coleta de pilhas", new Date(125, 0, 8),
                ...
                Protocolo prot88 = new Protocolo(null, secEducacao, mun1, end4, "Pavimentação asfáltica",
                                new Date(125, 0, 8),
                                "Asfaltamento de vias", Status.CIENCIA, 600000.0, "088-2026", prazo1);

                // Grupo de protocolos no dia 15/01/2026
                Protocolo prot89 = new Protocolo(null, secSaude, mun2, end3, "Fertilizantes orgânicos",
                                new Date(125, 0, 15),
                                "Produção de compostagem", Status.CIENCIA, 35000.0, "089-2026", prazo2);
                Protocolo prot90 = new Protocolo(null, secSaude, mun1, end2, "Centro convivência idosos",
                                new Date(125, 0, 15),
                                "Atividades para idosos", Status.CIENCIA, 90000.0, "090-2026", prazo3);

                // Fevereiro 2026
                Protocolo prot91 = new Protocolo(null, secEducacao, mun1, end4, "Educação infantil",
                                new Date(125, 1, 4),
                                "Ampliação de vagas", Status.CIENCIA, 180000.0, "091-2026", prazo1);
                Protocolo prot92 = new Protocolo(null, secSaude, mun2, end3, "Pronto atendimento", new Date(125, 1, 4),
                ...
                Protocolo prot93 = new Protocolo(null, secMeioAmb, mun1, end2, "Corredor ecológico",
                                new Date(125, 1, 4),
                                "Conectividade de fragmentos", Status.CIENCIA, 80000.0, "093-2026", prazo3);

                // Grupo de protocolos no dia 12/02/2026
                ...
                Protocolo prot95 = new Protocolo(null, secSaude, mun2, end3, "Sementes crioulas", new Date(125, 1, 12),
                                "Banco de sementes", Status.CIENCIA, 25000.0, "095-2026", prazo2);

                // Março 2026
                Protocolo prot96 = new Protocolo(null, secSaude, mun1, end2, "Auxílio emergencial", new Date(125, 2, 3),
                                "Apoio a famílias em vulnerabilidade", Status.CIENCIA, 300000.0, "096-2026", prazo3);
                Protocolo prot97 = new Protocolo(null, secEducacao, mun1, end4, "Educação especial",
                                new Date(125, 2, 3),
                                "Sala de recursos multifuncionais", Status.CIENCIA, 110000.0, "097-2026", prazo1);
                Protocolo prot98 = new Protocolo(null, secSaude, mun2, end3, "Sala de vacina", new Date(125, 2, 3),
                                "Reforma de salas", Status.CIENCIA, 75000.0, "098-2026", prazo2);

                // Grupo de protocolos no dia 10/03/2026
                Protocolo prot99 = new Protocolo(null, secMeioAmb, mun1, end2, "Unidade de conservação",
                                new Date(125, 2, 10),
                                "Criação de parque municipal", Status.CIENCIA, 150000.0, "099-2026", prazo3);
                Protocolo prot100 = new Protocolo(null, secEducacao, mun1, end4, "Urbanização de favela",
                                new Date(125, 2, 10),
                                "Infraestrutura básica", Status.CIENCIA, 2500000.0, "100-2026", prazo1);
